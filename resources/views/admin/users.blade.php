    ...
    <div class="mx-auto max-w-screen-xl">
        ...
        <div id="reservations" class="mt-12">
            <div class="flex align-middle justify-center">
                ...
                <p class="my-2 mx-8  p-2 font-bike font-bold text-gray-600 text-lg ">Admins</p>
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <a href="{{ route('addAdmin') }}" class="flex  w-40  border-2 border-pr-500 hover:text-white hover:bg-pr-400 font-bike font-medium p-1 " >
        ...
        <div class="grid md:grid-cols-3  gap-6 mt-6">
            @foreach ($admins as $admin)
                <div class="bg-white shadow-xl rounded-md flex  justify-start items-center mx-2 ">
                    ...
                    <div class="my-3 ">
                        <h2 class="font-bike text-gray-900 font-semibold text-xl">{{ $admin->name }}</h2>
        ...
        <div id="reservations" class="mt-12">
            <div class="flex align-middle justify-center">
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <p class="my-2 mx-8  p-2 font-bike font-bold text-gray-600 text-lg ">Clients</p>
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <hr>
            </div>
