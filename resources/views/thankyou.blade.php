    ...
    <div class="h-screen bg-gray-200 flex justify-center items-center ">
        <div class="bg-white md:w-3/5 h-4/5 rounded-lg mx-4 shadow-xl flex flex-col justify-start items-center gap-8">
            <div class="w-32 mt-10">
                <img loading="lazy"  src="/images/logos/LogoPFE.png" alt="">
            </div>
            <div class="">
                <h1 class="font-car font-bold text-gray-900 text-6xl text-center">Thank You ❤️</h1>
                <p class="font-car text-center">Thank you for trusting BicycleMaroc</p>
            </div>
            <div class="relative bg-gray-200 md:w-3/5 m-4 md:mt-10">
                ...
                <div class="p-3">
                    ...
                    <p class="text-lg font-car text-gray-600 text-justify">You can go to any of our BicycleMaroc locations near you and
                        present your reservation invoice (digital or printed) and receive your bike!</p>
                    <div class="mt-2 flex justify-center">
                        <a href="{{route('recu', ['reservation'=>$reservation->id])}}"
