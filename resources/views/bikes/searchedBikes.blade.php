    ...
    <div class="mt-6 mb-2 grid md:grid-cols-3  justify-center items-center mx-auto max-w-screen-xl">
        @forelse ($bikes as $bike)
            <div
                ...
                <a class="relative flex mx-3 mt-3 overflow-hidden h-60 rounded-xl" href="{{ route('bike.reservation', ['bike' => $bike->id]) }}">
                    <img loading="lazy" class="object-cover" src="{{ $bike->image }}" alt="product image" />
                    <span
                        class="absolute top-0 left-0 px-2 m-2 text-sm font-medium text-center text-white rounded-full bg-pr-400">{{ $bike->reduce }}
                        %
                        OFF</span>
                </a>
                <div class="px-5 pb-5 mt-4">
                    <div class="flex items-center justify-between mt-2 mb-5">
                        <p>
                            <span class="text-3xl font-bold text-slate-900">{{ $bike->price_per_hour }}</span>
                            <span
                                class="text-sm line-through text-slate-900">{{ intval(($bike->price_per_hour * 100) / (100 - $bike->reduce)) }}
                            </span>
                        </p>
                        ...
                        <div class="flex items-center">
                            ...
                            @endfor
                            <span
                                class="mr-2 ml-3 rounded bg-pr-300 px-2.5 py-0.5 text-xs font-semibold">{{ $bike->stars }}.0</span>
                        </div>
                    </div>
        ...
        @empty
            ...
            <div class="mx-auto max-w-screen-xl h-[300px] items-center ">
                <p class="mx-auto mt-[100px] text-4xl font-medium font-bike  ">no bike fond ! </p>
            </div>
            <div class="mx-auto max-w-screen-xl h-[300px] items-center ">
                <p class="mx-auto"></p>
            </div>
